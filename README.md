...
|  #  | Title | Solution | Time | Space | Difficulty |Tag| Note|
|-----|-------| -------- | ---- | ------|------------|---|-----|
|100|[Same Tree](https://leetcode.com/problems/same-tree/)| [Python LBYL version](https://github.com/yuzhoujr/LeetCode/blob/master/tree/Yu/100_isSameTree.py)  [Python EAFP version](https://github.com/yuzhoujr/LeetCode/blob/master/tree/YeSheng/100.Same_Tree.py) | _O(N)_| _O(1)_  | Easy ||[EAFP vs. LBYL](https://github.com/ictar/python-doc/blob/master/Others/%E5%AE%9E%E7%94%A8Python%EF%BC%9AEAFP%20VS.%20LBYL.md)|
